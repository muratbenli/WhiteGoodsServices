            ...
            <div className=" mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <span className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
                    <svg id="Layer_1" enableBackground="new 0 0 512 512" height="512"
                         className="w-12 h-12 text-white p-2 rounded-full" viewBox="0 0 512 512" width="512"
                ...
                <Link to="/">
                    <span className="mr-5 hover:text-gray-400">Anasayfa</span>
                </Link>
                <Link to="/servisler">
                    <span className="mr-5 hover:text-gray-400">Servisler</span>
                </Link>
                <Link to="/iletisim">
